...
export default function AdminMemberTable({
  ...
  // 1. Handle adding +2 to siege score
  ...
  // 2. Toggle between fighter and skiller ranks
  ...
  // Sort members - incorrect ranks at top, hidden at bottom

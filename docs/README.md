# Siege Clan Tracker Documentation

This directory contains comprehensive documentation for the Siege Clan Tracker project.

## 📁 Documentation Structure

### Planning Documents (`/planning`)
Planning and roadmap documentation for future development:
...
- **[local-setup.md](setup/local-setup.md)** - Local development environment setup instructions
- **[staging-setup.md](setup/staging-setup.md)** - Staging database setup and testing procedures
...
2. Follow [local-setup.md](setup/local-setup.md) to set up your development environment
...
2. Test changes before production deployment
...
1. Place planning docs in `/docs/planning`
2. Place setup guides in `/docs/setup`
3. Update this README with links to new docs
4. Keep docs current with code changes
